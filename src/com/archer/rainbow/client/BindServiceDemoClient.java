...
import com.archer.rainbow.R;
import com.archer.rainbow.service.BindServiceDemoService;
...
public class BindServiceDemoClient extends Activity {
	...
	private class IncomingHandler extends Handler {
		/*
		 * 处理从Service发送至该Activity的消息 (non-Javadoc)
		 * 
		...
		public void handleMessage(Message msg) {
			...
			case MSG_SET_VALUE:
				Toast.makeText(BindServiceDemoClient.this,
						"set value as: " + msg.arg1, Toast.LENGTH_SHORT).show();
				break;
			default:
	...
	private void doBindService() {
		...
		Intent intent = new Intent(this, BindServiceDemoService.class);
